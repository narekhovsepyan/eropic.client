    ...
    Panzoom.prototype = {
        ...
        setMatrix: function(matrix, options) {
            ...
            if (contain) {
                ...
                width = dims.width + dims.widthBorder; //image width
                height = dims.height + dims.heightBorder; //image height
                // Use absolute value of scale here as negative scale doesn't mean even smaller
                marginW = ((width * Math.abs(scale)) - container.width) / 2; //negative left step
                marginH = ((height * Math.abs(scale)) - container.height) / 2; //negative top step
                left = dims.left + dims.margin.left; //original left step
                top = dims.top + dims.margin.top; //original top step
                if (contain === 'invert') {
                    //https://github.com/varmais/jquery.panzoom/blob/9e0497da15d3a28da89280f12f4db01df387f0ef/src/panzoom.js
